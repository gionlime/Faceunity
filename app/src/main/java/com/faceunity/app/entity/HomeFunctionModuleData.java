...
public class HomeFunctionModuleData {
    ...
    public static ArrayList<HomeFunctionModuleData> buildData() {
        ...
        data.add(new HomeFunctionModuleData(R.mipmap.ico_home_hair, R.string.home_function_name_hair,"16-0"));
        ...
        data.add(new HomeFunctionModuleData(R.mipmap.ico_home_big_head, R.string.home_function_name_big_head,"96-0"));
        data.add(new HomeFunctionModuleData(R.mipmap.ico_home_poster_face, R.string.home_function_name_poster_face,"96-0"));
        ...
        data.add(new HomeFunctionModuleData(R.mipmap.ico_home_face_warp, R.string.home_function_name_face_warp,"96-0"));
        ...
        data.add(new HomeFunctionModuleData(R.mipmap.ico_home_human_avatar, R.string.home_function_name_human_avatar,"96-0"));
//        data.add(new HomeFunctionModuleData(R.mipmap.ico_home_action_recognition, R.string.home_function_name_action_recognition));
        ...
        data.add(new HomeFunctionModuleData(R.mipmap.ico_home_green_curtain, R.string.home_function_name_green_curtain,"96-0"));
